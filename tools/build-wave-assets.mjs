...
const bodyImage=await loadImage(new URL('assets/nuoji-body-v3.png',root).pathname);
const repair=await loadImage(new URL('assets/nuoji-wave-repair-green-v1.png',root).pathname);
...
fs.writeFileSync(new URL('assets/nuoji-wave-body-v3.png',root),body.toBuffer('image/png'));
fs.writeFileSync(new URL('assets/nuoji-wave-leg-v1.png',root),limb.toBuffer('image/png'));
...
const raised=await loadImage(new URL('assets/nuoji-raised-paw-green-v1.png',root).pathname);
...
fs.writeFileSync(new URL('assets/nuoji-wave-folded-v1.png',root),forearm.toBuffer('image/png'));
for(const [name,upper] of [['upper',true],['lower',false]]){
 ...
 fs.writeFileSync(new URL('assets/nuoji-wave-'+name+'-v1.png',root),c.toBuffer('image/png'));
}
...
fs.writeFileSync(new URL('assets/nuoji-wave-paw-v1.png',root),paw.toBuffer('image/png'));
...
fs.writeFileSync(new URL('assets/nuoji-wave-shaft-v1.png',root),shaft.toBuffer('image/png'));
...
fs.writeFileSync(new URL('assets/nuoji-wave-cuff-v1.png',root),cuff.toBuffer('image/png'));
